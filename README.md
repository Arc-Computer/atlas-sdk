...
- **Stateful Adapter Handshake** – Self-managed orchestrators can declare `control_loop=self`, stream adapter telemetry, and let Atlas handle teacher rewards without prompt rewrites ([design note](docs/adapters/adapters.md)).
